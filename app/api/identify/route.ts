...
const uuid  = require("uuid");;
  ...
  async function getInformationFromGemini(input: Input) {
    ...
    const parts = [
      {text: "As a user, I provide you an image from an art work which I captured on museum, or in an art gallery, or from internet, or a screenshot. You receive the URL. Your job is, as a smart assistant, educate user about that art work. \
       You have a professional, simple, funny, friendly passion tone. \
       ...
       \nYou put all these data together, in a story telling way, with passion, simplified fashion. \
       You provide information based on reliable resources. \
       At the end of your response, you generate a list of recommended artworks related to this work, with title, artist name, and an image url, and an link to external resources to read more. \n \
