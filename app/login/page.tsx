              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  ...
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    Explore artworks like never before with our AI-powered art companion. Get
                    detailed insights, historical context, and engage in natural conversations about
                    any artwork through text or voice chat.
                  </p>
